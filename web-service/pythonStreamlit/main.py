...
selected_algorithm = st.radio(
    ...
    ["Гомография (SIFT) для поворота/масштаба", "Фазовая корреляция для точного сдвига"],
    index=0,
)

# Связь названий с методами API
algorithm_map = {
    "Гомография (SIFT) для поворота/масштаба": "sift",
    "Фазовая корреляция для точного сдвига": "phase_correlation",
}
